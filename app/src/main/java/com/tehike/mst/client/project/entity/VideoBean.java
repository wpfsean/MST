package com.tehike.mst.client.project.entity;

import com.tehike.mst.client.project.onvif.MediaProfile;
...
public class VideoBean implements Serializable{
    ...
    public VideoBean(String channel, String devicetype, String id, String ipaddress, String name, String password, int port, String username, String serviceUrl, String mediaUrl, String shotPicUrl, String ptzUrl, String rtsp, String token) {
        this.channel = channel;
        this.devicetype = devicetype;
        this.id = id;
        this.ipaddress = ipaddress;
